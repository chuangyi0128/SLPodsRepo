...
Pod::Spec.new do |s|
  ...
  s.subspec 'QQSDK' do |ss|
    ss.source_files = 'TencentSDKs/TencentOpenAPI.framework/Headers'
    ss.resource = 'TencentSDKs/TencentOpenApi_IOS_Bundle.bundle'
    ss.libraries = 'stdc++','z','sqlite3','iconv'
    ss.vendored_frameworks = 'TencentSDKs/TencentOpenAPI.framework'
